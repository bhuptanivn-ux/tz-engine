...
// replaces the earlier Nifty 50 placeholder now that the real list is
// available. Source: NSE's own EQUITY_L.csv (SYMBOL, NAME OF COMPANY, ...),
// mapped to Yahoo Finance's ".NS" suffix convention used throughout this
// app. Swap/regenerate this file if the NSE listing changes materially.
...
export const SCREENER_UNIVERSE: UniverseEntry[] = [
  ...
  { symbol: "ABAN.NS", name: "Aban Offshore Limited" },
  ...
  { symbol: "ACGL.NS", name: "Automobile Corporation of Goa Limited" },
  ...
  { symbol: "ADDIND.NS", name: "Addi Industries Limited" },
  ...
  { symbol: "ADVIKCA.NS", name: "Advik Capital Limited" },
  ...
  { symbol: "AGSTRA.NS", name: "AGS Transact Technologies Limited" },
  ...
  { symbol: "ALFREDHE.NS", name: "Alfred Herbert India Limited" },
  ...
  { symbol: "ALUFLUOR.NS", name: "Alufluoride Limited" },
  { symbol: "AMAGI.NS", name: "Amagi Media Labs Limited" },
  { symbol: "AMAL.NS", name: "Amal Limited" },
  { symbol: "AMANTA.NS", name: "Amanta Healthcare Limited" },
  { symbol: "AMARJOTHI.NS", name: "Amarjothi Spinning Mills Limited" },
  ...
  { symbol: "ANDREWYU.NS", name: "Andrew Yule & Company Limited" },
  ...
  { symbol: "ANNAPURNA.NS", name: "Annapurna Swadisht Limited" },
  { symbol: "ANNU.NS", name: "Annu Projects Limited" },
  { symbol: "ANSALAPI.NS", name: "Ansal Properties & Infrastructure Limited" },
  { symbol: "ANSALBU.NS", name: "Ansal Buildwell Limited" },
  ...
  { symbol: "APOORVA.NS", name: "Apoorva Leasing Finance and Investment Company Limited" },
  ...
  { symbol: "ARCIL.NS", name: "Asset Reconstruction Company (India) Limited" },
  { symbol: "ARCL.NS", name: "ARCL Organics Limited" },
  { symbol: "ARDEE.NS", name: "Ardee Industries Limited" },
  ...
  { symbol: "ARYAMAN.NS", name: "Aryaman Financial Services Limited" },
  ...
  { symbol: "ASIANTNE.NS", name: "Asian Tea & Exports Limited" },
  { symbol: "ASKAUTOLTD.NS", name: "ASK Automotive Limited" },
  { symbol: "ASMS.NS", name: "Avio Smart Market Stack Limited" },
  { symbol: "ASPINWALL.NS", name: "Aspinwall and Company Limited" },
  { symbol: "ASSAMENT.NS", name: "Assam Entrade Limited" },
  ...
  { symbol: "AUGMONT.NS", name: "Augmont Enterprises Limited" },
  ...
  { symbol: "AUSTENG.NS", name: "Austin Engineering Company  Limited" },
  ...
  { symbol: "AVANCE.NS", name: "Avance Technologies Limited" },
  ...
  { symbol: "AXTEL.NS", name: "Axtel Industries Limited" },
  ...
  { symbol: "AZADIND.NS", name: "Azad India Mobility Limited" },
  ...
  { symbol: "BENARAS.NS", name: "Benares Hotels Limited" },
  ...
  { symbol: "BILVYAPAR.NS", name: "BIL VYAPAR LIMITED" },
  ...
  { symbol: "BLEL.NS", name: "Behari Lal Engineering Limited" },
  ...
  { symbol: "BLUECLOUDS.NS", name: "Blue Cloud Softech Solutions Limited" },
  ...
  { symbol: "BPLPHARMA.NS", name: "Bharat Parenterals Limited" },
  { symbol: "BRAHMINFRA.NS", name: "Brahmaputra Infrastructure Limited" },
  { symbol: "BRIGADE.NS", name: "Brigade Enterprises Limited" },
  { symbol: "BRIGHOTEL.NS", name: "Brigade Hotel Ventures Limited" },
  { symbol: "BRIGHTBR.NS", name: "Bright Brothers Limited" },
  ...
  { symbol: "BURNPUR.NS", name: "Burnpur Cement Limited" },
  ...
  { symbol: "CFEL.NS", name: "Confidence Futuristic Energetech Limited" },
  { symbol: "CGCL.NS", name: "Capri Global Capital Limited" },
  { symbol: "CGPOWER.NS", name: "CG Power and Industrial Solutions Limited" },
  { symbol: "CGVAK.NS", name: "CG Vak Software & Exports Limited" },
  ...
  { symbol: "CHEMCRUX.NS", name: "Chemcrux Enterprises Limited" },
  ...
  { symbol: "COMPEAU.NS", name: "Competent Automobiles Company Limited" },
  ...
  { symbol: "CRAVATEX.NS", name: "Cravatex Limited" },
  ...
  { symbol: "CRESTO.NS", name: "CRESTO TECHNO LIMITED" },
  ...
  { symbol: "CRSL.NS", name: "Cressanda Railway Solutions Limited" },
  ...
  { symbol: "DEEP.NS", name: "Deep Polymers Limited" },
  { symbol: "DEEPA.NS", name: "Deepa Jewellers Limited" },
  ...
  { symbol: "DHABRIYA.NS", name: "Dhabriya Polywood Limited" },
  ...
  { symbol: "DHARAN.NS", name: "DHARAN INFRA-EPC LIMITED" },
  { symbol: "DHARMAJ.NS", name: "Dharmaj Crop Guard Limited" },
  { symbol: "DHATRE.NS", name: "Dhatre Udyog Limited" },
  { symbol: "DHOOTTRANS.NS", name: "Dhoot Transmission Limited" },
  ...
  { symbol: "DOLLEX.NS", name: "Dollex Agrotech Limited" },
  ...
  { symbol: "DSKULKARNI.NS", name: "DS Kulkarni Developers Limited" },
  ...
  { symbol: "EASTWEST.NS", name: "East West Freight Carriers Limited" },
  { symbol: "EBGNG.NS", name: "GNG Electronics Limited" },
  { symbol: "EBIX.NS", name: "EBIX Limited" },
  { symbol: "ECLERX.NS", name: "eClerx Services Limited" },
  { symbol: "ECORECO.NS", name: "Eco Recycling Limited" },
  ...
  { symbol: "EKI.NS", name: "EKI Energy Services Limited" },
  ...
  { symbol: "EMPIND.NS", name: "Empire Industries Limited" },
  ...
  { symbol: "ENKEIWHEL.NS", name: "Enkei Wheels (India) Limited" },
  ...
  { symbol: "ESDS.NS", name: "ESDS Software Solution Limited" },
  ...
  { symbol: "FREDUN.NS", name: "Fredun Pharmaceuticals Limited" },
  ...
  { symbol: "GAJA.NS", name: "Gaja Alternative Asset Management Limited" },
  ...
  { symbol: "GENSOL.NS", name: "Gensol Engineering Limited" },
  ...
  { symbol: "GFSTEELS.NS", name: "Grand Foundry Limited" },
  ...
  { symbol: "GKB.NS", name: "GKB Ophthalmics Limited" },
  ...
  { symbol: "GLASSWALL.NS", name: "Glass Wall Systems (India) Limited" },
  ...
  { symbol: "HAMPTON.NS", name: "Hampton Sky Realty Limited" },
  ...
  { symbol: "HEXAGON.NS", name: "Hexagon Nutrition Limited" },
  ...
  { symbol: "HINDADH.NS", name: "Hindustan Adhesives Limited" },
  { symbol: "HINDALCO.NS", name: "Hindalco Industries Limited" },
  { symbol: "HINDALUMI.NS", name: "Hind Aluminium Industries Limited" },
  ...
  { symbol: "HIRECT.NS", name: "Hirect Limited" },
  ...
  { symbol: "HORIZONIND.NS", name: "Horizon Industrial Parks Limited" },
  ...
  { symbol: "HRYNSHP.NS", name: "Hariyana Ship Breakers Limited" },
  { symbol: "HSCL.NS", name: "Himadri Speciality Chemical Limited" },
  { symbol: "HTEL.NS", name: "Hy-Tech Engineers Limited" },
  ...
  { symbol: "INDOKEM.NS", name: "Indokem Limited" },
  ...
  { symbol: "IPRINGLTD.NS", name: "IP Rings Limited" },
  ...
  { symbol: "ISTLTD.NS", name: "I S T Limited" },
  ...
  { symbol: "ITL.NS", name: "ITL Industries Limited" },
  ...
  { symbol: "JENBURPH.NS", name: "Jenburkt Pharmaceuticals Limited" },
  ...
  { symbol: "JNPR.NS", name: "Juniper Green Energy Limited" },
  ...
  { symbol: "JYOTIRES.NS", name: "Jyoti Resins & Adhesives Limited" },
  ...
  { symbol: "KAMANWALA.NS", name: "Kamanwala Housing Construction Limited" },
  ...
  { symbol: "KANCOTEA.NS", name: "Kanco Tea & Industries Limited" },
  { symbol: "KANOHAR.NS", name: "Kanohar Electricals Limited" },
  ...
  { symbol: "KARAMTARA.NS", name: "Karamtara Engineering Limited" },
  ...
  { symbol: "KDGREEN.NS", name: "KD Green Industries Limited" },
  ...
  { symbol: "KJMCFIN.NS", name: "KJMC Financial Services Limited" },
  { symbol: "KKCL.NS", name: "Kewal Kiran Clothing Limited" },
  { symbol: "KLBRENG-B.NS", name: "Kilburn Engineering Limited" },
  { symbol: "KMCSHIL.NS", name: "K M C Speciality Hospitals (India) Limited" },
  ...
  { symbol: "KSE.NS", name: "KSE Limited" },
  ...
  { symbol: "LADDERUP.NS", name: "Ladderup Finance Limited" },
  ...
  { symbol: "LAKSHMIMIL.NS", name: "Lakshmi Mills Company Limited" },
  { symbol: "LAL.NS", name: "Lorenzini Apparels Limited" },
  { symbol: "LALITHAA.NS", name: "Lalithaa Jewellery Mart Limited" },
  { symbol: "LALPATHLAB.NS", name: "Dr. Lal Path Labs Ltd." },
  { symbol: "LAMBODHARA.NS", name: "Lambodhara Textiles Limited" },
  { symbol: "LANCER.NS", name: "Lancer Container Lines Limited" },
  ...
  { symbol: "LCCPROJECT.NS", name: "LCC Projects Limited" },
  { symbol: "LCL.NS", name: "Lohia Corp Limited" },
  { symbol: "LEAPIND.NS", name: "LEAP India Limited" },
  { symbol: "LEENEE.NS", name: "Lee & Nee Softwares Exports Limited" },
  ...
  { symbol: "LKPSEC.NS", name: "LKP Securities Limited" },
  ...
  { symbol: "LOTUSCHO.NS", name: "Lotus Chocolate Company Limited" },
  ...
  { symbol: "LUMINO.NS", name: "Lumino Industries Limited" },
  ...
  { symbol: "MAKERSL.NS", name: "Makers Laboratories Limited" },
  ...
  { symbol: "MANIPALHOS.NS", name: "Manipal Health Enterprises Limited" },
  ...
  { symbol: "MBECL.NS", name: "Mcnally Bharat Engineering Company Limited" },
  ...
  { symbol: "MEDICAPQ.NS", name: "Medi Caps Limited" },
  ...
  { symbol: "MIIL.NS", name: "Meghna Infracon Infrastructure Limited" },
  { symbol: "MILKYMIST.NS", name: "Milky Mist Dairy Food Limited" },
  { symbol: "MINALIND.NS", name: "Minal Industries Limited" },
  ...
  { symbol: "MKEXIM.NS", name: "M.K. Exim (India) Limited" },
  { symbol: "MKPL.NS", name: "M K Proteins Limited" },
  { symbol: "MLKFOOD.NS", name: "Milkfood Limited" },
  ...
  { symbol: "MOHITE.NS", name: "Mohite Industries Limited" },
  ...
  { symbol: "MPDL.NS", name: "MPDL Limited" },
  { symbol: "MPHASIS.NS", name: "MphasiS Limited" },
  { symbol: "MPIMANIPAL.NS", name: "Manipal Payment and Identity Solutions Limited" },
  ...
  { symbol: "MSL.NS", name: "Mangalam Seeds Limited" },
  ...
  { symbol: "MUKESHB.NS", name: "Mukesh Babu Financial Services Limited" },
  ...
  { symbol: "MVELECTRO.NS", name: "MV Electrosystems Limited" },
  { symbol: "MVGJL.NS", name: "Manoj Vaibhav Gems N Jewellers Limited" },
  { symbol: "MWL.NS", name: "Mangalam Worldwide Limited" },
  { symbol: "MYSORPETRO.NS", name: "Mysore Petro Chemicals Limited" },
  ...
  { symbol: "NEUEON.NS", name: "Neueon Corporation Limited" },
  ...
  { symbol: "NICCOPAR.NS", name: "Nicco Parks & Resorts Limited" },
  ...
  { symbol: "NTCIND.NS", name: "NTC Industries Limited" },
  ...
  { symbol: "ODYCORP.NS", name: "Odyssey Corporation Limited" },
  ...
  { symbol: "ONEGLOBAL.NS", name: "One Global Service Provider Limited" },
  ...
  { symbol: "ONIDA.NS", name: "Onida Electronics Limited" },
  { symbol: "ONIXSOLAR.NS", name: "Onix Solar Energy Limited" },
  ...
  { symbol: "OPTIFIN.NS", name: "Optimus Finance Limited" },
  ...
  { symbol: "ORIRAIL.NS", name: "Oriental Rail Infrastructure Limited" },
  ...
  { symbol: "PACIFICI.NS", name: "Pacific Industries Limited" },
  ...
  { symbol: "PANCHMAHQ.NS", name: "Panchmahal Steel Limited" },
  { symbol: "PANORAMA.NS", name: "Panorama Studios International Limited" },
  ...
  { symbol: "PARNAXLAB.NS", name: "Parnax Lab Limited" },
  ...
  { symbol: "PBMPOLY.NS", name: "PBM Polytex Limited" },
  ...
  { symbol: "PERMAGN.NS", name: "Permanent Magnets Limited" },
  { symbol: "PERNIASPOP.NS", name: "Purple Style Labs Limited" },
  ...
  { symbol: "PHOENXINTL.NS", name: "Phoenix International Limited" },
  ...
  { symbol: "PNC.NS", name: "PNC Media and Entertainment Limited" },
  ...
  { symbol: "POEL.NS", name: "POCL Enterprises Limited" },
  ...
  { symbol: "POLYSPIN.NS", name: "Polyspin Exports Limited" },
  ...
  { symbol: "PRANAV.NS", name: "Pranav Constructions Limited" },
  { symbol: "PRASOLCHEM.NS", name: "Prasol Chemicals Limited" },
  ...
  { symbol: "PRIORITY.NS", name: "Priority Jewels Limited" },
  { symbol: "PRISMX.NS", name: "Prismx Global Ventures Limited" },
  ...
  { symbol: "RELINFRA.NS", name: "Reliance Infrastructure Limited" },
  { symbol: "RELTD.NS", name: "Ravindra Energy Limited" },
  { symbol: "REMSONSIND.NS", name: "Remsons Industries Limited" },
  { symbol: "RENTOMOJO.NS", name: "Rentomojo Limited" },
  ...
  { symbol: "RRECL.NS", name: "RDB Real Estate Constructions Limited" },
  ...
  { symbol: "RTSPOWR.NS", name: "RTS Power Corporation Limited" },
  ...
  { symbol: "SAB.NS", name: "SAB Industries Limited" },
  ...
  { symbol: "SAICAPI.NS", name: "Sai Capital Limited" },
  ...
  { symbol: "SAMBANDAM.NS", name: "Sambandam Spinning Mills Limited" },
  ...
  { symbol: "SAYAJIIND.NS", name: "Sayaji Industries Limited" },
  ...
  { symbol: "SEKURITIND.NS", name: "Saint Gobain Sekurit India Limited" },
  ...
  { symbol: "SETUINFRA.NS", name: "Setubandhan Infrastructure Limited" },
  ...
  { symbol: "SGLRES.NS", name: "SGL Resources Limited" },
  { symbol: "SGMART.NS", name: "SG Mart Limited" },
  { symbol: "SGRL.NS", name: "Shree Ganesh Remedies Limited" },
  ...
  { symbol: "SHANKESH.NS", name: "Shankesh Jewellers Limited" },
  ...
  { symbol: "SHERVANI.NS", name: "Shervani Industrial Syndicate Limited" },
  { symbol: "SHILCTECH.NS", name: "Shilchar Technologies Limited" },
  { symbol: "SHILGRAVQ.NS", name: "Shilp Gravures Limited" },
  { symbol: "SHILPAMED.NS", name: "Shilpa Medicare Limited" },
  { symbol: "SHINDL.NS", name: "Sharat Industries Limited" },
  { symbol: "SHIPROCKET.NS", name: "Shiprocket Limited" },
  { symbol: "SHIVAAGRO.NS", name: "Shiva Global Agro Industries Limited" },
  { symbol: "SHIVACEM.NS", name: "Shiva Cement Limited" },
  ...
  { symbol: "SHRADDHA.NS", name: "Shraddha Prime Projects Limited" },
  ...
  { symbol: "SHRJAGP.NS", name: "Shri Jagdamba Polymers Limited" },
  { symbol: "SHUKRAPHAR.NS", name: "Shukra Pharmaceuticals Limited" },
  ...
  { symbol: "SIEL.NS", name: "Superior Industrial Enterprises Limited" },
  ...
  { symbol: "SIMBHALS.NS", name: "Simbhaoli Sugars Limited" },
  { symbol: "SIMPLEXINF.NS", name: "Simplex Infrastructures Limited" },
  { symbol: "SIMPLXREA.NS", name: "Simplex Realty Limited" },
  ...
  { symbol: "SKYWAYS.NS", name: "Skyways Air Services Limited" },
  ...
  { symbol: "SRIKPRIND.NS", name: "Sri KPR Industries Limited" },
  ...
  { symbol: "STEAMHOUSE.NS", name: "Steamhouse India Limited" },
  ...
  { symbol: "STLSTRINF.NS", name: "Steel Strips Infrastructures Limited" },
  ...
  { symbol: "SUMEDHA.NS", name: "Sumedha Fiscal Services Limited" },
  ...
  { symbol: "SUNLOC.NS", name: "Sunil Healthcare Limited" },
  { symbol: "SUNPHARMA.NS", name: "Sun Pharmaceutical Industries Limited" },
  { symbol: "SUNRAKSHAK.NS", name: "Sunrakshakk Industries India Limited" },
  { symbol: "SUNSHIEL.NS", name: "Sunshield Chemicals Limited" },
  { symbol: "SUNSHINE.NS", name: "Sunshine Pictures Limited" },
  ...
  { symbol: "SUPTANERY.NS", name: "Super Tannery Limited" },
  ...
  { symbol: "SVGLOBAL.NS", name: "S V Global Mill Limited" },
  ...
  { symbol: "SWARAJ.NS", name: "Swaraj Suiting Limited" },
  { symbol: "SWARAJENG.NS", name: "Swaraj Engines Limited" },
  { symbol: "SWARNSAR.NS", name: "Swarnsarita Jewels India Limited" },
  { symbol: "SWELECTES.NS", name: "Swelect Energy Systems Limited" },
  { symbol: "SWIGGY.NS", name: "Swiggy Limited" },
  { symbol: "SWISSMLTRY.NS", name: "Swiss Military Consumer Goods Limited" },
  { symbol: "SWSOLAR.NS", name: "Sterling and Wilson Renewable Energy Limited" },
  { symbol: "SYMBIOTEC.NS", name: "Symbiotec Pharmalab Limited" },
  ...
  { symbol: "TECHNOCRAF.NS", name: "Technocraft Ventures Limited" },
  ...
  { symbol: "TEMPSENS.NS", name: "Tempsens Instruments (India) Limited" },
  { symbol: "TENNIND.NS", name: "Tenneco Clean Air India Limited" },
  { symbol: "TERAI.NS", name: "Terai Tea Company Limited" },
  ...
  { symbol: "TGVSL.NS", name: "TGV Sraac Limited" },
  ...
  { symbol: "TOYAMSL.NS", name: "Toyam Sports Limited" },
  ...
  { symbol: "TRANSCOR.NS", name: "Transcorp International Limited" },
  ...
  { symbol: "TRITONV.NS", name: "Triton Valves Limited" },
  ...
  { symbol: "TUTIALKA.NS", name: "Tuticorin Alkali Chemicals & Fertilizers Limited" },
  ...
  { symbol: "UDAYJEW.NS", name: "Uday Jewellery Industries Limited" },
  ...
  { symbol: "UPHOT.NS", name: "U P Hotels Limited" },
  ...
  { symbol: "VADILENT.NS", name: "Vadilal Enterprises Limited" },
  ...
  { symbol: "VASUPRADA.NS", name: "Shri Vasuprada Plantations Limited" },
  ...
  { symbol: "VEDAVAAG.NS", name: "VEDAVAAG Systems Limited" },
  ...
  { symbol: "VEEGALAND.NS", name: "Veegaland Developers Limited" },
  ...
  { symbol: "VGCL.NS", name: "Vibrant Global Capital Limited" },
  ...
  { symbol: "VIJSOLX.NS", name: "Vijay Solvex Limited" },
  ...
  { symbol: "VIRAT.NS", name: "Virat Industries Limited" },
  { symbol: "VIRINCHI.NS", name: "Virinchi Limited" },
  { symbol: "VIRTUALG.NS", name: "Virtual Global Education Limited" },
  { symbol: "VISACHROME.NS", name: "VISA Chrome Limited" },
  { symbol: "VISAKAIND.NS", name: "Visaka Industries Limited" },
  { symbol: "VISHAL.NS", name: "Vishal Fabrics Limited" },
  ...
  { symbol: "VIVIANA.NS", name: "Viviana Power Tech Limited" },
  { symbol: "VIVIDHA.NS", name: "Visagar Polytex Limited" },
  { symbol: "VIVIMEDLAB.NS", name: "Vivimed Labs Limited" },
  { symbol: "VIVOBIOT.NS", name: "Vivo Bio Tech Limited" },
  ...
  { symbol: "VOITHPAPR.NS", name: "Voith Paper Fabrics India Limited" },
  ...
  { symbol: "VTMLTD.NS", name: "VTM Limited" },
  ...
  { symbol: "WARDINMOBI.NS", name: "Wardwizard Innovations & Mobility Limited" },
  { symbol: "WATERBASE.NS", name: "Waterbase Limited" },
  ...
  { symbol: "WHBRADY.NS", name: "WH Brady & Company Limited" },
  ...
  { symbol: "XTRANET.NS", name: "Xtranet Technologies Limited" },
  ...
  { symbol: "YOGI.NS", name: "Yogi Limited" },
